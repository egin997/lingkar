...
4. Run pgTAP and database advisors/lint before promotion. Never include seed in production.
5. Configure exact auth redirects, custom SMTP, backups/PITR, network restrictions, and alerts.
